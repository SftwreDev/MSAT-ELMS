...
class Quiz(models.Model):
    ...
    description = models.CharField(
        ...
        blank=True, help_text=_("a description of the quiz"), max_length = 100)
    ...
    success_text = models.CharField(
        ...
        verbose_name=_("Success Text"), max_length = 100)

    fail_text = models.CharField(
        verbose_name=_("Fail Text"),
        blank=True, help_text=_("Displayed if user fails."), max_length = 100)
...
class Progress(models.Model):
    ...
    """
    user = models.OneToOneField(settings.AUTH_USER_MODEL, verbose_name=_("User"), related_name='user_progress', on_delete=models.CASCADE)
...
class Sitting(models.Model):
    ...
    user = models.ForeignKey(settings.AUTH_USER_MODEL, verbose_name=_("User"), related_name='user_sitting', on_delete=models.CASCADE)
...
class Answer(models.Model):
    question = models.ForeignKey(QuizQuestions, verbose_name='Question', on_delete=models.CASCADE)
